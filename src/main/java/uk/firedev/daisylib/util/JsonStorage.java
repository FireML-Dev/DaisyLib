...
public class JsonStorage {
    ...
    public static @NotNull <T> List<T> parseList(@NotNull String json, @NotNull Class<T> clazz) {
        ...
        try {
            ...
            Loggers.warn(JsonStorage.class, "Invalid JSON!", exception);
            return List.of();
        }
    }
    ...
    public static @Nullable Chunk parseChunk(@NotNull String json) {
        ...
        if (world == null) {
            Loggers.warn(JsonStorage.class, "World " + worldName + " does not exist!");
            return null;
        }
        int x;
        int z;
        try {
            ...
            Loggers.warn(JsonStorage.class, "Invalid chunk coordinates!", exception);
            return null;
        }
