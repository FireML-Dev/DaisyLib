package uk.firedev.daisylib.utils.warmup;
...
public class WarmupHandler extends BukkitRunnable {
    ...
    protected WarmupHandler(int warmupSeconds, @NotNull Player player) {
        this.warmupSeconds = warmupSeconds;
        this.player = player;
        this.initialLocation = processLocation(player.getLocation());
    }

    public static WarmupHandler warmupHandler(int warmupSeconds, @NotNull Player player) {
