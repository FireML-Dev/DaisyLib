...
public class JsonStorage {
    ...
    private static final Logging logging = Logging.logging(JsonStorage.class);
    ...
    public static @NonNull <T> List<T> parseList(@NonNull String json, @NonNull Class<T> clazz) {
        ...
        try {
            ...
            logging.warn("Invalid JSON!", exception);
            return List.of();
        }
    }
    ...
    public static @Nullable Chunk parseChunk(@NonNull String json) {
        ...
        if (world == null) {
            logging.warn("World " + worldName + " does not exist!");
            return null;
        }
        int x;
        int z;
        try {
            ...
            logging.warn("Invalid chunk coordinates!", exception);
            return null;
        }
